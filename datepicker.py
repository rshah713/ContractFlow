...
<MonthYearLabel>:
    ...
    color: 0.9294117647058824, 0.592156862745098, 0.2980392156862745, 1
    size_hint: None, 0.1
    halign: "center"
...
class DatePicker(TextInput):
    ...
    def __init__(self, addcls, touch_switch=False, *args, **kwargs):
        """
            addcls: monkey-patched by me (Rohan)
        - static AddMeeting class which has a field date_save_list
         - passed by ref so changes will affect the original one
         outside this class
        """
    ...
    def update_value(self, inst):
        ...
        """
        10.6.2022 --> 'June 10 2022'
        day.month.year --> month day year
        """
        
        readable = datetime.strptime(self.text, "%d.%m.%Y").strftime('%B %d')
        
        
        DatePicker.addcls.date_save_list = [readable]
        self.addcls.ids.workdate.text = readable
        self.focus = False
